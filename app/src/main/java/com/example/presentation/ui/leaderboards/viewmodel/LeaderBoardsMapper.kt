...
class LeaderBoardsMapper {
  ...
  fun map(): List<LeaderBoards> {
    return listOf(
      ...
      LeaderBoards("2-player PvE", R.drawable.leaderboarads_12_pve, "Table #4"),
      LeaderBoards("1-player PvE", R.drawable.leaderboard_1vs1_pvp, "Table #5"),
      LeaderBoards("2-player PvE", R.drawable.leaderboard_1, "Table #6"),
    )
  }
}